...
export class CalendarInlineExample extends React.Component<
	ICalendarInlineExampleProps,
	ICalendarInlineExampleState
> {
	...
	public render(): JSX.Element {
		...
		if (this.state.selectedDateRange) {
			...
			const rangeEnd = this.state.selectedDateRange[
				this.state.selectedDateRange.length - 1
			]
			dateRangeString =
				...
				{(this.props.minDate || this.props.maxDate) && (
					<div>
						...
						<span>
							{" "}
							{this.props.minDate
								? this.props.minDate.toLocaleDateString()
								: "Not set"}
							-
							{this.props.maxDate
